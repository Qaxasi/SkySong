...
import com.mycompany.SkySong.application.user.login.ports.AccessTokenGeneratorOnLogin;
...
public class UserAuthenticator {
    ...
    public Result<AuthenticationTokens> login(final LoginInput loginInput) {
        try {
            ...
            final AccessToken tokens = tokenGenerator.generate(user);



            sessionUserStore.save(tokens.refreshToken(), new SessionData(user.id(), user.usernameOrEmail(), user.roles()));
